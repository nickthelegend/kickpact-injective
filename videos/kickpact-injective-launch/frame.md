...
colors:
  # Kickpact dark two-tone: navy ground + periwinkle ink (cobalt-grid inverted).
  # The ink IS the accent — one color for type, grid, hairlines, glitch, QR.
  # Gold (#e8b84b) is a RARE second highlight (verified ✓ / CTA only).
  paper: "#10162e"
  paper-2: "#1b2548"
  ink: "#627eea"
  ink-soft: "#8aa0f5"
  grid: "rgba(98, 126, 234, 0.12)"
  ink-faint: "rgba(98, 126, 234, 0.22)"
  gold: "#e8b84b"
  success: "#54c468"
...
- **Fonts** — already set to **KickpactPixel** (display) / **KickpactDisplay** (body); ignore any preset font name lingering in prose.
